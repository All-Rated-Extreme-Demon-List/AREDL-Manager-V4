  ...
  options: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          name: "high-extremes",
          description: "Whether to only show players with 50+ extremes",
  ...
  if (subcommand === "mutualvictors") {
    ...
    if (ID1 === ID2) {
      const container = (
        <Container accentColor={0xff0000}>
          ...
          <TextDisplay>
            You must select two different levels. That's the whole point of the
            command...
          </TextDisplay>
        </Container>
      );
    ...
    const victors = victorsData
      ...
      .sort((a, b) => {
        ...
        const aOrder = sortOrder.find((o) => o.type === aType)?.order ?? -1;
        const bOrder = sortOrder.find((o) => o.type === bType)?.order ?? -1;
